package com.github.modsezam.api.binance.impl;

import com.github.modsezam.api.binance.BinanceApiAsyncRestClient;
import com.github.modsezam.api.binance.BinanceApiCallback;
import com.github.modsezam.api.binance.config.BinanceApiConfig;
import com.github.modsezam.api.binance.constant.BinanceApiConstants;
import com.github.modsezam.api.binance.domain.account.Account;
import com.github.modsezam.api.binance.domain.account.DepositAddress;
import com.github.modsezam.api.binance.domain.account.DepositHistory;
import com.github.modsezam.api.binance.domain.account.NewOrder;
import com.github.modsezam.api.binance.domain.account.NewOrderResponse;
import com.github.modsezam.api.binance.domain.account.Order;
import com.github.modsezam.api.binance.domain.account.Trade;
import com.github.modsezam.api.binance.domain.account.TradeHistoryItem;
import com.github.modsezam.api.binance.domain.account.WithdrawHistory;
import com.github.modsezam.api.binance.domain.account.WithdrawResult;
import com.github.modsezam.api.binance.domain.account.request.AllOrdersRequest;
import com.github.modsezam.api.binance.domain.account.request.CancelOrderRequest;
import com.github.modsezam.api.binance.domain.account.request.CancelOrderResponse;
import com.github.modsezam.api.binance.domain.account.request.OrderRequest;
import com.github.modsezam.api.binance.domain.account.request.OrderStatusRequest;
import com.github.modsezam.api.binance.domain.event.ListenKey;
import com.github.modsezam.api.binance.domain.general.Asset;
import com.github.modsezam.api.binance.domain.general.ExchangeInfo;
import com.github.modsezam.api.binance.domain.general.ServerTime;
import com.github.modsezam.api.binance.domain.market.AggTrade;
import com.github.modsezam.api.binance.domain.market.BookTicker;
...
import com.github.modsezam.api.binance.domain.market.OrderBook;
import com.github.modsezam.api.binance.domain.market.TickerPrice;
import com.github.modsezam.api.binance.domain.market.TickerStatistics;

import java.util.List;

import static com.github.modsezam.api.binance.impl.BinanceApiServiceGenerator.createService;
